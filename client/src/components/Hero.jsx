...
const Hero = () => {
  ...
  return (
    ...
    <div className="bg-[url('/bg.png')] bg-cover bg-no-repeat min-h-screen px-4 sm:px-20 xl:px-32 relative inline-flex flex-col w-full items-center justify-center py-40">

        <p className="text-xs border px-4 text-primary py-2 rounded-full mt-4 text-center"><Rocket className="w-5 h-5 inline mx-1 text-center"/> Your All-in-One AI Platform.</p>
      ...
      <div className="flex items-center justify-center gap-3 mt-8 text-sm">
        ...
        <a href="#ai-tools"><button className="cursor-pointer text-gray-500 border border-gray-500 rounded-lg px-6 flex gap-2 py-3">
        <Sparkles className="w-5 h-5 text-center justify-center"/> AI tools
        </button></a>
      </div>
